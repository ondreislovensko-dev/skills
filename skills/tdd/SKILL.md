...
metadata:
  ...
  tags: ["tdd", "testing", "red-green-refactor", "integration-tests", "test-first"]
  use-cases:
    - "Build a new feature using test-driven development with tracer bullets"
    - "Fix a bug using the red-green-refactor loop"
    - "Write integration tests that test behavior through public interfaces"
