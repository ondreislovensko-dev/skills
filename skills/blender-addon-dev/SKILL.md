...
Use `bpy.types.PropertyGroup` to define custom settings stored on scenes, objects, or other Blender data. See [references/REFERENCE.md](references/REFERENCE.md) for all property types and a full example.
