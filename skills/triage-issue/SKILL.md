...
metadata:
  ...
  tags: ["triage", "bug", "github-issues", "tdd", "root-cause-analysis"]
  use-cases:
    - "Investigate a reported bug and create a GitHub issue with a TDD fix plan"
    - "Triage an issue by exploring the codebase to find the root cause"
    - "File a bug report with acceptance criteria and red-green fix cycles"
