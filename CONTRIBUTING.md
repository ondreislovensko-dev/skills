...
Thank you for your interest in contributing. This guide explains how to create use cases and skills, and submit them for inclusion in the library.
...
Use cases are problem-first guides that show how AI agents solve real challenges. They live in the `use-cases/` directory and are published on [terminalskills.io/use-cases](https://terminalskills.io/use-cases).
...
Skills are the building blocks that make use cases work. Every skill should be traceable back to a real use case — a concrete problem that developers encounter regularly.
...
- Skills without a clear use case they serve
...
4. Add or link to a use-case in `use-cases/` (recommended)
5. Update the skills table in `README.md`
6. Submit a PR with:
   - A clear title: "Add skill: your-skill-name"
   - Which use case this skill serves
